...
class Result(BaseModel):
    ...
    page_age: Optional[str] = Field(description="A date representing the age of the web page.")
    page_fetched: Optional[str] = Field(description="A date representing when the web page was last fetched.")
